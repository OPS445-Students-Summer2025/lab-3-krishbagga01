...
def give_first_item():
    # Does not accept any arguments 
    # Returns a list that includes the first item in the global object my_list as a string 
    return str(my_list[0])
def give_first_and_last_item():
    # Does not accept any arguments
    # Returns a list that includes the first and last items in the global bject my_list 
